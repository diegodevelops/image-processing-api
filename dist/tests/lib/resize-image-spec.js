...
describe('tests for resizeImage', function () {
    var filePath = 'assets/full/japan.jpg';
    var newFilePath = 'assets/20x20/japan.jpg';
    var width = 20;
    var height = 20;
    it('should return true', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, resize_image_1.default)(filePath, newFilePath, width, height)];
                case 1:
                    answer = _a.sent();
